...
ALLOWED_HOSTS = []  # Update with your actual domain names in production
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # You can place global templates here
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Ensure that the app is ready to serve media files in development
if DEBUG:
    MEDIA_URL = '/media/'
